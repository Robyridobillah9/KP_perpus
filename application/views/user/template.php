...
<body class="hold-transition skin-blue layout-top-nav">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?= date('Y') ?> <a href="">Roby Ridobillah</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-5">
                            <img id="" width="200" height="350" src="" alt="foto sampul buku">
                        </div>
                        <div class="col-md-7">
                            <table class="table table-striped">
                                <tr>
                                    <td>Judul Buku</td>
                                    <td id="judul_buku" <?= base_url('buku/add') ?> method="POST" enctype="multipart/form-data"></td>
                                </tr>
                                <tr>
                                    <td>Penerbit</td>
                                    <td id="penerbit"></td>
